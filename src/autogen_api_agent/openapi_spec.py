...
_spec = {
    ...
    "paths": {
        ...
        "/v1/chat/completions": {"post": {"tags": ["OpenAI"], "responses": {"200": {"description": "OK"}}}},
        "/v1/agent/chat": {"post": {"tags": ["Multi-Agent"], "responses": {"200": {"description": "OK"}}}},
        "/v1/providers": {"get": {"tags": ["Providers"], "responses": {"200": {"description": "OK"}}}},
        ...
        "/gateway/health": {"get": {"tags": ["Gateway"], "responses": {"200": {"description": "OK"}}}},
        "/security/approvals": {"get": {"tags": ["Security"], "responses": {"200": {"description": "OK"}}}},
        "/swiss/providers": {"get": {"tags": ["Swiss AI"], "responses": {"200": {"description": "OK"}}}},
        "/composable/tools": {"get": {"tags": ["Composable"], "responses": {"200": {"description": "OK"}}}},
        "/extensions": {"get": {"tags": ["Extensions"], "responses": {"200": {"description": "OK"}}}},
        "/local/node": {"get": {"tags": ["Local Web"], "responses": {"200": {"description": "OK"}}}}
    },
    "tags": [
